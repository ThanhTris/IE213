...
const initialUsers = [
  {
    ...
    walletAddress: "0x742d35Cc6634C0532925a3b844Bc9e7595f0d8f",
    role: "user",
    status: "active",
    joinDate: "2025-03-15",
    lastActive: "2026-04-13 10:30",
    warrantyCount: 3,
  },
  {
    id: "2",
    ...
    walletAddress: "0x8a3d94Cc6634C0532925a3b844Bc9e7595f0bc2",
    role: "admin",
    status: "active",
    joinDate: "2024-11-20",
    lastActive: "2026-04-13 09:15",
    warrantyCount: 5,
  },
  {
    id: "3",
    ...
    walletAddress: "0x1f5a84Cc6634C0532925a3b844Bc9e7595f0a6c",
    role: "user",
    status: "active",
    joinDate: "2023-06-10",
    lastActive: "2026-04-12 16:45",
    warrantyCount: 1,
  },
  {
    id: "4",
    ...
    walletAddress: "0x9c2b74Cc6634C0532925a3b844Bc9e7595f0e3d",
    role: "user",
    status: "inactive",
    joinDate: "2025-08-05",
    lastActive: "2026-03-20 14:20",
    warrantyCount: 2,
  },
  {
    id: "5",
    ...
    walletAddress: "0x7d4e64Cc6634C0532925a3b844Bc9e7595f0f2a",
    role: "guest",
    status: "active",
    joinDate: "2026-01-12",
    lastActive: "2026-04-13 08:00",
    warrantyCount: 0,
  },
];
...
function UserManagement() {
  ...
  const [newUser, setNewUser] = useState({ fullName: "", email: "", walletAddress: "", role: "user" });
  ...
  const handleAddUser = () => {
    ...
    const parts = newUser.fullName.trim().split(" ");
          ...
          <tbody>
            {filteredUsers.map((user, idx) => (
              <tr key={user.id}>
                ...
                <td style={{ color: "#475569", fontSize: 14 }}>{user.joinDate}</td>
                <td style={{ color: "#475569", fontSize: 14 }}>{user.lastActive}</td>
